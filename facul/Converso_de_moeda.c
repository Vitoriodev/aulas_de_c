...
void Bem_vindo(int *escolher) {
    printf("Ola, sejam bem-vindos ao conversor de moedas!\n");
    printf("Qual moeda voce quer converter?\n");
    printf("1: Real\n2: Dolar\n3: Euro\n4: Peso Argentino\n");
    printf("Digite o numero da moeda ou 0 para sair: ");
    scanf("%d", escolher);
}
...
void converter(int escolher, float *moedas_BRL, float *moedas_USD, float *moedas_EUR, float *moedas_ARS) {
    ...
    switch (escolher) {
        ...
        case 4: // Peso Argentino
            printf("Digite o valor em Peso Argentino: ");
            scanf("%f", &valor);
